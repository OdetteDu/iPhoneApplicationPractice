...
- (void)drawRect:(CGRect)rect
{
    ...
    {
        [[UIImage imageNamed:@"bg.png"] drawInRect:self.bounds];
    }
}
...
- (void)drawCorners
{
    ...
    NSAttributedString *cornerText = [[NSAttributedString alloc] initWithString: [NSString stringWithFormat:@"%@", [self rankAsString]] attributes:@{ NSParagraphStyleAttributeName : paragraphStyle, NSFontAttributeName : cornerFont}];
